...
BUILD_CROSS_COMPILE_COMPAT=/home/pascua14/gcc-4.9/bin/arm-linux-androideabi-
...
$KERNEL_MAKE_ENV ARCH=arm64 CROSS_COMPILE=$BUILD_CROSS_COMPILE \
CROSS_COMPILE_COMPAT=$BUILD_CROSS_COMPILE_COMPAT \
CC=$KERNEL_LLVM_BIN CLANG_TRIPLE=$CLANG_TRIPLE r8q_defconfig
...
make -j8 -C $(pwd) O=$(pwd)/out $KERNEL_MAKE_ENV \
ARCH=arm64 CROSS_COMPILE=$BUILD_CROSS_COMPILE \
CROSS_COMPILE_COMPAT=$BUILD_CROSS_COMPILE_COMPAT \
CC=$KERNEL_LLVM_BIN CLANG_TRIPLE=$CLANG_TRIPLE oldconfig
...
$KERNEL_MAKE_ENV ARCH=arm64 CROSS_COMPILE=$BUILD_CROSS_COMPILE \
CROSS_COMPILE_COMPAT=$BUILD_CROSS_COMPILE_COMPAT \
CC=$KERNEL_LLVM_BIN CLANG_TRIPLE=$CLANG_TRIPLE
